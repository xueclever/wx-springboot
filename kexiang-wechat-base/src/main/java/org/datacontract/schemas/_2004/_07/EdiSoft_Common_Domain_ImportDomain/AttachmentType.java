...
public class AttachmentType implements java.io.Serializable {
    ...
    public static final java.lang.String _Picture = "Picture";
    public static final java.lang.String _Text = "Text";
    public static final AttachmentType Picture = new AttachmentType(_Picture);
    public static final AttachmentType Text = new AttachmentType(_Text);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/EdiSoft.Common.Domain.ImportDomain", "AttachmentType"));
    }
    /**
